                ...
                StyledText {
                    ...
                    MouseArea {
                        ...
                        onClicked: mouse => {
                            ...
                            } else if (!parent.hoveredLink) {
                                const latest = notificationGroup?.latestNotification;
                                if (latest && NotificationService.activateNotification(latest))
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: mouse => {
                                                if (!parent.hoveredLink && (bodyText.hasMoreText || messageExpanded)) {
                                                    ...
                                                    if (modelData && NotificationService.activateNotification(modelData))
                                                        PopoutService.closeNotificationCenter();
                                                }
                                            }
